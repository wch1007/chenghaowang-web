...
The owner fixed the overarching palette to the original Accio Work direction.
Use ink-black / deep green backgrounds (#050807, #090d0b, #0c1210), warm-white
text (#f3f6f1), and mint (#59f3c5) as the primary accent. Lime (#ccff56) and
violet (#8e82ff) are secondary, local accents only. Preserve this direction in
future iterations unless the owner explicitly changes it.
...
- Accio Work uses a typographic wordmark, not a fabricated brand icon.

Do not publish student IDs, gradesheets, private certificates, or source decks.
Avoid exact award dates when the source supports only a study period.
